...
class CMonster_Boss_Griffin final : public CLandObject
{
private:
	explicit CMonster_Boss_Griffin(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CMonster_Boss_Griffin(const CMonster_Boss_Griffin& rhs);
	virtual ~CMonster_Boss_Griffin() = default;
...
public:
	static CMonster_Boss_Griffin* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
