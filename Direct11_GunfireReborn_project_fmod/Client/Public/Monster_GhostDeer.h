...
class CMonster_GhostDeer final : public CLandObject
{
private:
	explicit CMonster_GhostDeer(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CMonster_GhostDeer(const CMonster_GhostDeer& rhs);
	virtual ~CMonster_GhostDeer() = default;
...
private:
	...
	CTexture*			m_pDissolveTextrueCom = nullptr; //디졸브 텍스쳐
...
public:
	static CMonster_GhostDeer* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
