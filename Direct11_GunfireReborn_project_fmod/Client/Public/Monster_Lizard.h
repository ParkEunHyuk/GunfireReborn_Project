...
class CMonster_Lizard final : public CLandObject
{
private:
	explicit CMonster_Lizard(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	explicit CMonster_Lizard(const CMonster_Lizard& rhs);
	virtual ~CMonster_Lizard() = default;
...
public:
	static CMonster_Lizard* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
