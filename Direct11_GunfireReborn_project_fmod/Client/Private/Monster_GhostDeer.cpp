#include "stdafx.h"
#include "..\Public\Monster_GhostDeer.h"
#include "GameInstance.h"
#include "Item_Universal.h"


CMonster_GhostDeer::CMonster_GhostDeer(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CLandObject(pDevice, pDeviceContext)
{

}

CMonster_GhostDeer::CMonster_GhostDeer(const CMonster_GhostDeer & rhs)
	: CLandObject(rhs)
{
}

HRESULT CMonster_GhostDeer::NativeConstruct_Prototype()
{
...
HRESULT CMonster_GhostDeer::NativeConstruct(void * pArg)
{
...
_int CMonster_GhostDeer::Tick(_double TimeDelta)
{
	...
	{
		MSGBOX("Monster_GostDeer의 Add_ObseverGroup에 문제가 발생했습니다");
		return E_FAIL;
	}
...
_int CMonster_GhostDeer::LateTick(_double TimeDelta)
{
...
HRESULT CMonster_GhostDeer::Render()
{
...
HRESULT CMonster_GhostDeer::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(m_eNowLevelNum, TEXT("Prototype_Component_Model_GostDeer"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
	...
	ColliderDesc.vScale = _float3(1.5f, 4.f, 2.0f);
	ColliderDesc.vRotation = _float4(0.f, 0.f, 0.f, 1.f);
...
HRESULT CMonster_GhostDeer::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CMonster_GhostDeer::SetUp_Event_Tirgger(_double TimeDelta)
{
	return S_OK;
}

HRESULT CMonster_GhostDeer::SetUp_Fight(_double TimeDelta)
{
	Fight_On();
...
HRESULT CMonster_GhostDeer::Fight_On()
{
...
HRESULT CMonster_GhostDeer::Once_Trigger()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CMonster_GhostDeer::PlayAnim(_double TimeDelta)
{
...
HRESULT CMonster_GhostDeer::CoolTime_Manager(_double TimeDelta)
{
...
HRESULT CMonster_GhostDeer::Once_AnimMotion(_double TimeDelta) //무빙넘버와 공격넘버로 바꿔도 괜찮을듯?
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CMonster_GhostDeer::Infinity_AnimMotion(_double TimeDelta) //작업 완료
{
	if (true == m_bFight)
	{
...
_int CMonster_GhostDeer::Obsever_Hit(void* pArg)
{
...
_int CMonster_GhostDeer::Obsever_Event(void * pArg)
{
	CUniversal_Bullet* SorceBullet = static_cast<CUniversal_Bullet*>(pArg);
...
_int CMonster_GhostDeer::Dead_Trigger()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CMonster_GhostDeer::Universal_Bullet(_double TimeDelta)
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
	...
	if (true == m_bFire && m_dFireTime>0.4)
	{
		...
		Universal_BulletDesc.iBulletNumber = CUniversal_Bullet::BULLETTYPE::GHOSTDEER;
		...
		Universal_BulletDesc.fPositioning = _float3(-0.5f, 1.5, 0.f);
		...
		Universal_BulletDesc.iTextureIndex = 5;
		...
		GetSingle(CGameInstance)->PlaySound((L"GhostDeer_Bullet.mp3"), CHANNEL_EFFECT);
...
HRESULT CMonster_GhostDeer::Universal_Wield(_double TimeDelta)
{
	...
	if (true == m_bFire && m_dFireTime > 0.4)
	{
		...
		GetSingle(CGameInstance)->PlaySound((L"GhostDeer_Wield.mp3"), CHANNEL_EFFECT);
	}
...
HRESULT CMonster_GhostDeer::Slow_On()
{
...
HRESULT CMonster_GhostDeer::Notice()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CMonster_GhostDeer * CMonster_GhostDeer::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CMonster_GhostDeer*	pInstance = new CMonster_GhostDeer(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CMonster_GhostDeer");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CMonster_GhostDeer::Clone(void * pArg)
{
	CMonster_GhostDeer*	pInstance = new CMonster_GhostDeer(*this);
