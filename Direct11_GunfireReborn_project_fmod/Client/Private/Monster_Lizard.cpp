#include "stdafx.h"
#include "..\Public\Monster_Lizard.h"
#include "GameInstance.h"
#include "Item_Universal.h"


CMonster_Lizard::CMonster_Lizard(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CLandObject(pDevice, pDeviceContext)
{

}

CMonster_Lizard::CMonster_Lizard(const CMonster_Lizard & rhs)
	: CLandObject(rhs)
{
}

HRESULT CMonster_Lizard::NativeConstruct_Prototype()
{
...
HRESULT CMonster_Lizard::NativeConstruct(void * pArg)
{
...
_int CMonster_Lizard::Tick(_double TimeDelta)
{
...
_int CMonster_Lizard::LateTick(_double TimeDelta)
{
...
HRESULT CMonster_Lizard::Render()
{
...
HRESULT CMonster_Lizard::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(m_eNowLevelNum, TEXT("Prototype_Component_Model_Lizard"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CMonster_Lizard::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CMonster_Lizard::SetUp_Event_Tirgger(_double TimeDelta)
{
	return S_OK;
}

HRESULT CMonster_Lizard::SetUp_Fight(_double TimeDelta)
{
	Fight_On();
...
HRESULT CMonster_Lizard::Fight_On()
{
...
HRESULT CMonster_Lizard::Once_Trigger()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CMonster_Lizard::PlayAnim(_double TimeDelta)
{
...
HRESULT CMonster_Lizard::CoolTime_Manager(_double TimeDelta)
{
...
HRESULT CMonster_Lizard::Once_AnimMotion(_double TimeDelta) //무빙넘버와 공격넘버로 바꿔도 괜찮을듯?
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CMonster_Lizard::Infinity_AnimMotion(_double TimeDelta)
{
	if(true == m_bFight)
	{
...
_int CMonster_Lizard::Obsever_Hit(void* pArg)
{
...
_int CMonster_Lizard::Obsever_Event(void * pArg)
{
	CUniversal_Bullet* SorceBullet = static_cast<CUniversal_Bullet*>(pArg);
...
_int CMonster_Lizard::Dead_Trigger()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CMonster_Lizard::Universal_Bullet(_double TimeDelta)
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
	...
	if (true == m_bFire && m_dFireTime>0.7)
	{
		...
		GetSingle(CGameInstance)->PlaySound((L"Lizard_Bullet.mp3"), CHANNEL_EFFECT);
...
HRESULT CMonster_Lizard::Universal_Wield(_double TimeDelta)
{
	...
	if (true == m_bFire && m_dFireTime > 0.4)
	{
		...
		GetSingle(CGameInstance)->PlaySound((L"Lizard_Wield.mp3"), CHANNEL_EFFECT);
...
HRESULT CMonster_Lizard::Universal_StrikeDown(_double TimeDelta)
{
	...
	if (true == m_bFire && m_dFireTime > 0.4)
	{
		...
		GetSingle(CGameInstance)->PlaySound((L"Lizard_StrikeDown.mp3"), CHANNEL_EFFECT);
	}
...
HRESULT CMonster_Lizard::Slow_On()
{
...
HRESULT CMonster_Lizard::Notice()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CMonster_Lizard * CMonster_Lizard::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CMonster_Lizard*	pInstance = new CMonster_Lizard(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CMonster_Lizard");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CMonster_Lizard::Clone(void * pArg)
{
	CMonster_Lizard*	pInstance = new CMonster_Lizard(*this);
